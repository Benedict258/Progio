...
import { getPrivateGrants, addPrivateGrant, removePrivateGrant, type PrivateOpportunity } from "@/lib/storage";
...
export default function MyPrivateGrantsPage() {
  ...
  const refresh = () => setItems(getPrivateGrants());
    ...
    <div className="p-8 max-w-4xl">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-600">Manually add grant opportunities not in the database.</p>
        </div>
        <button
      ...
      {showForm && (
        <div className="bg-white rounded-xl border border-slate-200 p-6 mb-8 shadow-sm">
          <h2 className="text-lg font-semibold text-slate-900 mb-4">Add Private Grant</h2>
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                placeholder="e.g. Innovation Research Fund"
        ...
        {items.length === 0 ? (
          <div className="bg-white rounded-xl border border-slate-200 p-12 text-center">
            ...
            <p className="text-slate-500 max-w-md mx-auto">
              Add grant opportunities you found outside the platform to keep everything in one place.
            </p>
          </div>
        ) : (
          items.map((item) => (
