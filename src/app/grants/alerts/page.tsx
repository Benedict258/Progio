  ...
  return (
    <div className="p-8 max-w-4xl">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-slate-900 mb-2">Grant Alerts</h1>
          <p className="text-slate-600">Get notified about grant opportunities matching your criteria.</p>
        </div>
        <button
        ...
        {alerts.length === 0 ? (
          <div className="bg-white rounded-xl border border-slate-200 p-12 text-center">
            ...
            <p className="text-slate-500 max-w-md mx-auto">
              Create an alert to get notified when new grants match your field and region.
            </p>
          </div>
        ) : (
          alerts.map((alert) => (
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm font-medium text-slate-900">
                    {alert.field_of_study} grants &middot; {alert.region}
                  </p>
